...
# represents the core interface to the database, adapted throught a
# dialect that handles the details of the database and DBAPI in use. In
# this case the SQLite dialect will interpret instrucions to the Python
...
# created; instead, it's used the scenes by the ORM as we'll
# see shortly.
...
# models or class (the ORM models):
...
# to that base - this is know as the declarative base class. Our
