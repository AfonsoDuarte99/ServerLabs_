...
used to interface FastAPI with http clients, DQLAlchemy models
...
class PlayerBase(BaseModel):
    ...
    class Config:
        ...
        # https://docs.pydantic.dev/models/#orm-mode-aka-arbitrary-class-instances
        orm_mode = True
    #:
#:
...
#   name: str
#
# Have it in mind, so you don't get confused when using ':' with
# them.
...
class PlayerRegisterResult(BaseModel):
    id: int
#:
